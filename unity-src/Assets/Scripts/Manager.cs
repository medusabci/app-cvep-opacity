...
public class Manager : MonoBehaviour
{
    ...
    public Color32 defaultTextColor = new Color32(100, 100, 100, 255);
    public Color32 defaultPhotodiodeColor = new Color32(255, 255, 255, 255);
    public Color32 highlightPhotodiode = new Color32(75, 75, 75, 255);
    ...
    void FixedUpdate()
    {
        ...
        {
            if (photodiodeCell.GetComponent<Image>().color == highlightPhotodiode)
            {
                photodiodeCell.GetComponent<Image>().color = defaultPhotodiodeColor;
            }
            else if (photodiodeCell.GetComponent<Image>().color == defaultPhotodiodeColor)
            {
                photodiodeCell.GetComponent<Image>().color = highlightPhotodiode;
            }
        }
    ...
    void onParametersReady()
    {
        ...
        defaultBoxColor = hexToColor(parameters.default_box_color);
        defaultTextColor = hexToColor(parameters.default_text_color);
