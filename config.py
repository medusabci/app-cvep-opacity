...
class Config(QtWidgets.QDialog, ui_main_file):
    ...
    def __init__(self, sett, medusa_interface,
       ...
       sett: settings.Settings
        ...
        self.setupUi(self)
        self.TAG = '[apps/cvep_opacity/config] '
        ...
        if self.comboBox_mode.currentText() == 'Online':
            ...
            self.label_cvepmodel.setVisible(True)
            ...
            self.label_cvepmodel.setVisible(False)
        ...
        self.btn_color_background.clicked.connect(
            self.open_color_dialog(self.btn_color_background))
        ...
        self.btn_default_box_color.clicked.connect(
            self.open_color_dialog(self.btn_default_box_color))
        self.btn_default_text_color.clicked.connect(
            self.open_color_dialog(self.btn_default_text_color))
    ...
    def on_seqlen_changed(self):
        ...
        if mseqlen == 31:
            ...
            raise ValueError('[cvep_opacity/settings] Sequence length of %i '
    ...
    def set_settings_to_gui(self):
        ...
        gui_utils.modify_property(self.btn_default_box_color,
                                  'background-color',
                                  self.settings.colors.default_box_color[:7])
        gui_utils.modify_property(self.btn_default_text_color,
                                  'background-color',
                                  self.settings.colors.default_text_color[:7])
    ...
    def get_settings_from_gui(self):
        ...
        self.settings.colors.default_box_color = gui_utils.get_property(
            self.btn_default_box_color, 'background-color')
        self.settings.colors.default_text_color = gui_utils.get_property(
            self.btn_default_text_color, 'background-color')
...
class TargetConfigDialog(QtWidgets.QDialog, ui_target_file):
    ...
    def __init__(self, target, current_matrix_idx):
        ...
        self.TAG = '[apps/cvep_opacity/config_target] '
...
class VisualizeEncodingDialog(QtWidgets.QDialog, ui_encoding_file):
    def __init__(self, n_row, n_col, base, order, monitor_rate, item_list,
        ...
        self.setWindowFlags(
            self.windowFlags() & ~Qt.WindowContextHelpButtonHint)
        self.TAG = '[apps/cvep_opacity/config_encoding] '
