...
class AppController(TCPServer):
    ...
    def __init__(self, callback, app_settings, run_state):
        ...
        """
        # Parameters
        self.TAG = '[apps.cvep_opacity.AppController]'
    ...
    def send_parameters(self):
        ...
        msg["default_box_color"] = self.app_settings.colors.default_box_color
        msg["default_text_color"] = self.app_settings.colors.default_text_color
